...
mapniklite_src = Split(
  """
  mapniklite_datasource.cpp
  mapniklite_featureset.cpp
  """
        )
...
input_plugin = plugin_env.SharedLibrary('../mapniklite', source=mapniklite_src, SHLIBPREFIX='', SHLIBSUFFIX='.input', LIBS=libraries, LINKFLAGS=linkflags)
